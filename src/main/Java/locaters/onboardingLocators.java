...
public class onboardingLocators {
    ...
    @iOSXCUITFindBy(accessibility = "Choose the app language you prefer")
    ...
    @iOSXCUITFindBy(accessibility = "00000 00000")
    private WebElement phoneNumberTextField;

    @AndroidFindBy(uiAutomator = "new UiSelector().text(\"Send OTP\")")
    @iOSXCUITFindBy(xpath = "//XCUIElementTypeStaticText[@name=\"Send OTP\"]")
    ...
    @iOSXCUITFindBy(accessibility = "Start by entering your phone number")
    ...
    @iOSXCUITFindBy(accessibility = "Skip for devs")
